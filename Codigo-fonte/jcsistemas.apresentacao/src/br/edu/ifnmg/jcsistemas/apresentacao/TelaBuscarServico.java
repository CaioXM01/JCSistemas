 ...
 * @author caio
 */
public class TelaBuscarServico extends FormBuscar<Servico> {

    /**
     * Creates new form TelaBuscarServico
     */
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "BUSCAR SERVICO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        TelaCadastraServico tela = new TelaCadastraServico();
     ...
     public static void main(String args[]) {
       ...
       @Override
    protected void preencherTabela(List<Servico> dados) {
    ...
    @Override
    protected Servico carregaFiltro() {
    ...
    @Override
    protected Servico novaEntidade() {
        return new Servico();
    }
